...
<div class="br-mainpanel">
    ...
    <div class="br-pagetitle">
        ...
        <div>
            <h4>Informasi Data Survei Musem</h4>
            <p class="mg-b-0">
                Informasi Data Survei Museum.
            </p>
        </div>
    </div><!-- d-flex -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="button-group">
                                    <button class="btn btn-md btn-primary" onclick="add_survei()">
                        ...
                        <div class="row pt-5">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table id="tbl_survei" class="table display table-hover nowrap"
                                        style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                        ...
                                        <tbody>
                                            <?php if (count($surveidata) > 0) { ?>
                                            <?php $no = 1; ?>
                                            <?php foreach ($surveidata as $row) { ?>
                                            <tr>
                                                <td><span><?= $no++; ?></span></td>
                                                <td>
                                                    <div class="media mg-t-20 mg-b-0">
                                                        <img src="<?= base_url() ?>public/upload/kegiatan/survei/<?= $row->file_img; ?>"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="my-modal-title">Tambah Data Survei</h5>
                <button class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="#" method="post" id="form_survei" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-md-12">
                        <button class="btn btn-md btn-primary button-prevent" onclick="simpan_data_survei()">
