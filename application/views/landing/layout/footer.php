    ...
    <script src="<?= base_url() ?>public/landing/js/bootstrap.js"></script>
    <!-- Slick slider -->
    <script type="text/javascript" src="<?= base_url() ?>public/landing/js/slick.js"></script>
    <!-- Counter -->
    <script type="text/javascript" src="<?= base_url() ?>public/landing/js/waypoints.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>public/landing/js/jquery.counterup.js"></script>
    <!-- Mixit slider -->
