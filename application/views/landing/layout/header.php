...
<head>
    ...
    <title>SMK Negeri 7 Medan</title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="<?= base_url() ?>public/landing/img/logo.png" type="image/x-icon">

    <!-- Font awesome -->
    <link href="<?= base_url() ?>public/landing/css/font-awesome.css" rel="stylesheet">
    <!-- Bootstrap -->
    <link href="<?= base_url() ?>public/landing/css/bootstrap.css" rel="stylesheet">
    <!-- Slick slider -->
